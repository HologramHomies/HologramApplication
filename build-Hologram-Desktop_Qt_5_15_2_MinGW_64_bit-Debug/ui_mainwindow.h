...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        video_label->setMinimumSize(QSize(3, 5));

        grid_layout->addWidget(video_label, 0, 0, 1, 1);


        gridLayout->addLayout(grid_layout, 0, 0, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        video_label->setText(QCoreApplication::translate("MainWindow", "TextLabel", nullptr));
    } // retranslateUi
